      ...
      <nav className="fixed top-0 w-full z-50 glass border-b border-border/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2 group cursor-pointer">
            ...
            <span className="text-xl font-bold tracking-tight font-outfit">Team Task Manager</span>
          </div>
          <div className="flex items-center gap-4 sm:gap-6">
            <Link href="/login" className="text-sm font-semibold text-muted-foreground hover:text-foreground transition-colors hidden sm:block">Sign In</Link>
            <ThemeToggle />
            <Link href="/signup" className="bg-foreground text-background px-5 py-2.5 rounded-xl text-sm font-bold hover:opacity-90 transition-all shadow-xl shadow-foreground/10 active:scale-95">
              Get Started
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-10">
          ...
          <div className="flex flex-col items-center md:items-end gap-6 text-muted-foreground">
            <div className="flex gap-8 text-sm font-bold tracking-wide">
              ...
              <button onClick={() => setActiveModal('docs')} className="hover:text-primary transition-colors uppercase">Documentation</button>
            </div>
            <div className="flex items-center gap-6">
              <p className="text-sm font-semibold italic">© 2026 Team Task Manager. Built for the future.</p>
              <div className="h-4 w-px bg-border/50 hidden md:block" />
              <div className="flex gap-5">
                <a href="#" className="w-8 h-8 rounded-lg bg-foreground/5 flex items-center justify-center hover:bg-primary hover:text-white transition-all duration-300">
                ...
                <a href="#" className="w-8 h-8 rounded-lg bg-foreground/5 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all duration-300">
